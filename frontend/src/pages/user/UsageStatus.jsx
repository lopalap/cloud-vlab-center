...
function UsageStatus({ reservationId, onMovePage }) {
  ...
  const isDocker = !!reservation.os_preset;
          ...
          <div className="resource-info-grid">
            {isDocker ? (
              <>
                ...
                <div className="resource-info-item">
                  <span>호스트 노드</span>
                  <strong>{reservation.container_info?.host || resource?.name || "-"}</strong>
                </div>

                <div className="resource-info-item">
                  <span>컨테이너 상태</span>
                  <strong>
                    {reservation.container_id ? "실행 중" : "준비 중"}
                  </strong>
                </div>
              </>
            ) : (
        ...
        <section className="content-card">
          ...
          <div className="access-info-list">
            ...
            <div>
              <span>비밀번호</span>
              <strong>
                {reservation.container_info?.password || "-"}
              </strong>
            </div>
          </div>
